...
class TestDefaultStrategy(TestCase):
    ...
    def test_get_parser(self):
        ...
        with mock.patch("mod_lns.lib.strategies.default_strategy.get_default_parser", return_value=strat_parser) as get_parser:
    ...
    def test_pre_setup(self):
        ...
        with mock.patch.object(
            ...
            self.strategy.config, 'get_lns_solver_configuration', wraps=self.strategy.config.get_lns_solver_configuration
        ) as mock_get_lns_config, mock.patch.object(
            self.strategy.config, 'get_init_solver_configuration', wraps=self.strategy.config.get_init_solver_configuration
    ...
    def test_get_first_solution(self):
        ...
        """
        self.strategy.solver = ClingoSolver()
        with mock.patch.object(self.strategy.solver, "solve", return_value=None) as mock_solve:
        ...
        model = Model()
        with mock.patch.object(self.strategy.solver, "solve", return_value=model) as mock_solve:
    ...
    def test_check_accept(self):
        ...
        with mock.patch(
            "mod_lns.lib.strategies.default_strategy.calculate_variability", return_value=33
        ) as mock_variability:
