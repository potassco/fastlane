...
class TestSolverClingo(TestCase):
    ...
    def test_setup(self):
        ...
        self.assertIsInstance(self.solver._ctl, clingo.control.Control)
        self.assertIsNone(self.solver._thy)
    ...
    def test_solver_under_assumptions(self):
        ...
        self.assertTrue(
            self.solver.solve_under_assumptions(self.lns, []).satisfiable
        )
...
class TestSolverClingoDL(TestSolverClingo):
    ...
    def test_setup(self):
        ...
        self.assertDictEqual(self.lns.param_values["clingo_args"], {"rand-freq": 0.8})
        self.assertIsInstance(self.solver._ctl, clingo.control.Control)
        self.assertIsInstance(self.solver._thy, clingodl.ClingoDLTheory)
